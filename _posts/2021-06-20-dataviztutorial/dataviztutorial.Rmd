---
title: "Data Viz Tutorial"
description: |
  Learning the techniues of Data Viz taught by [Dr. Kam Tin Siong](https://faculty.smu.edu.sg/profile/kam-tin-seong-486), a professor at Singapore Management University (SMU)
author:
  - name: Amrita Mishra
...
In this article, we will show you how to plot a figure with multiple histograms by using [**ggplot2**](https://ggplot2.tidyverse.org/) and [**ggpubr**](https://cran.r-project.org/web/packages/ggpubr/ggpubr.pdf) packages. 
...
![](IMG/image01.png)
The screenshot below shows how to edit the file:
