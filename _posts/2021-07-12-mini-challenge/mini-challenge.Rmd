...
readr, readxl, ggplot2, dplyr, ggiraph, plotly,
...
Based on the visual plots created using absolute count, we can check with locations had the highest numbers based of the loyalty and credit card data.
...
The loyalty data has 1392 rows and cr_card data has 1490 rows. This suggests that a 1-1 mapping may not be available. Irrespective, we can use the count function to count the popular destinations from the 2 data sets.
...
The above 2 data sets coincide to reflect that the above ae the 4 popular destinations which are frequented by the GAStech employees.
